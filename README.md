...
The goal is to demonstrate the security differences between a **Secure Baseline** and a **Vulnerable Target** (Phase 2), utilizing automated pipelines and forensic logging.
